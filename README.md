...
`tissue sca coef [1/cm]` - коэффициент рассеяния (приведённый!).  
...
`np sca coef [1/cm]` – коэффициент рассеяния (приведённый) НЧ. Этот параметр должен уже учитывать концентрацию НЧ в ткани.   
